...
Trabalho da disciplina Laboratório de Experimentação de Software, referente ao Laboratório 01. O objetivo é estudar características de repositórios open-source populares, minerando dados dos 1.000 repositórios com mais estrelas no GitHub via API GraphQL (com script próprio do grupo, sem bibliotecas de terceiros) para responder a 7 questões de pesquisa sobre maturidade, adicionando outras questões bônus, contribuição externa, releases, atualização, linguagem e issues fechadas. Em paralelo, o grupo também configura e mantém um quadro Kanban (GitHub Projects) para acompanhar o próprio processo de desenvolvimento ao longo do semestre.
...
|---|---|
| Mediana | 39 releases |
| Repositórios sem nenhuma release | 286 (28,7%) |
...
|---|---|
| Mediana | 0 dias |
| Repositórios atualizados nos últimos 30 dias | 996 (100%) |
...
|---|---|
| Mediana | 0,864 (86,4%) |
| Repositórios com razão ≥ 0,70 | 721 (72,2%) |
...
| Discussions | Repositórios |
|---|---|
| Habilitado | 569 (57,1%) |
| Não habilitado | 427 (42,9%) |

**RQ XI - Apoio financeiro via funding (Sponsors e afins)**

| Funding | Repositórios |
|---|---|
| Com pelo menos uma plataforma configurada | 374 (37,6%) |
| Sem funding | 622 (62,4%) |

Plataformas mais comuns entre os 374 com funding:

| Plataforma | Repositórios |
|---|---|
| GitHub Sponsors | 297 |
| CUSTOM/link próprio | 121 |
| Open Collective | 111 |
| Patreon | 38 |
| Ko-fi | 25 |
...
| Métrica | Valor |
|---|---|
| Forks (mediana) | 6.348 (mínimo 39, máximo 109.021) |
| Concentração do maior contribuidor (mediana) | 0,333 (33,3%) entre os 978 repositórios com PRs identificáveis na amostra |

Licença (contagem, top 5):
